...
export class RenderEngine {
  constructor(mainCanvas, gridConfig, egf, terrainGrid, terrainImages) {
    Debug.log(DB.RND, 'Constructor called', { gridConfig });
  ...
  resize(width, height) {
    Debug.log(DB.RND, 'Resizing layers', { width, height });
  ...
  renderFull(cellSize, offsetX, offsetY) {
    Debug.log(DB.RND, 'Rendering full canvas', { cellSize, offsetX, offsetY });
  ...
  renderDirty(dirtyCells, cellSize, offsetX, offsetY) {
    Debug.log(DB.RND, 'Rendering dirty cells', { dirtyCells });
  ...
  renderEGFLayer(cellSize, offsetX, offsetY) {
    Debug.log(DB.RND_EGF, 'Rendering EGF Layer');
    this.egfLayer.clear();
  ...
  renderEGFCell(i, j, cellSize, offsetX, offsetY) {
    ...
    Debug.log(DB.RND_EGF, `EGF Cell [${i},${j}]`, { arv, brightness, colorValue });
  ...
  renderTerrainLayer(cellSize, offsetX, offsetY) {
    Debug.log(DB.RND_TERR, 'Rendering Terrain Layer');
  ...
  renderTerrainCell(i, j, cellSize, offsetX, offsetY) {
    ...
    Debug.log(DB.RND_TERR, `Terrain Cell [${i},${j}]`, { type, size, x, y });
  ...
  combineLayers() {
    Debug.log(DB.RND, 'Combining layers');
